...
public class RepositorioArrayDisciplina2 extends RepositorioArray<Disciplina> implements Repositorio<Disciplina> {
	...
	public RepositorioArrayDisciplina2() {// Tamanho default = 500000
		super();
	...
	public Iterator<Disciplina> iterator() {// Ele já pecorre o array da classe
										// pai.vv
		IteratorArrayDisciplina2 it = new IteratorArrayDisciplina2(super.getArray());
		return it;
	}
